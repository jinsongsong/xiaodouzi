...
/**
 * Controls whether to show the Shadow. Default is NO.
 */
@property (nonatomic,assign) BOOL showChartShadow;

@property (nonatomic) NSArray *shadowColors;
/**
 ...
 */
@property (nonatomic, getter = isShowCoordinateAxis) BOOL showCoordinateAxis;  //显示坐标轴
@property (nonatomic) BOOL showArrow; //显示箭头
@property (nonatomic) BOOL showBreakpoint; //显示坐标轴小短线
